...
require 'transfer/ProdutoParcelaHomeTransfer.php';

require 'repository/ProdutoParcelaHomeRepository.php';
require 'configuration/ProdutoParcelaHomeConfiguration.php';
require 'mockup/ProdutoParcelaHomeMockup.php';
require 'response/ProdutoParcelaHomeResponse.php';
require 'service/ProdutoParcelaHomeService.php';
require 'transfer/ProdutoParcelaHomeResponseTransfer.php';
require 'transfer/ProdutoParcelaHomeRequestTransfer.php';
require 'request/ProdutoParcelaHomeRequest.php';
require 'view/ProdutoParcelaHomeView.php';
require 'widget/ProdutoParcelaHomeWidget.php';
require 'controller/ProdutoParcelaHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoParcelaHomeController();
    ...
    public function service()
    {
        ...
        $requestTransfer = new ProdutoParcelaHomeRequestTransfer;
        $service = new ProdutoParcelaHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoParcelaHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoParcelaHomeResponseTransfer;
        $mockupLista = ProdutoParcelaHomeMockup::retornarLista();
        $mockupItem = ProdutoParcelaHomeMockup::retornarItem();

        $response = new ProdutoParcelaHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoParcelaHomeRequest();
    ...
    public function transfer()
    {
        header('Content-Type: application/json; charset=utf-8');
        $mockupDados = ProdutoParcelaHomeMockup::retornarItem();
        $objetoLista = new ProdutoParcelaHomeTransfer($mockupDados);
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoParcelaHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoParcelaHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoParcelaHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoParcelaHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoParcelaHomeView();
