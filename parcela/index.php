...
require_once 'mockup/ProdutoParcelaHomeMockup.php';

require_once '../includes/interfaces/ProdutoHomeTransferInterface.php';
require_once 'transfer/ProdutoParcelaHomeTransfer.php';
require_once 'mockup/ProdutoParcelaHomeMockup.php';
...
class Startup
{
    public static function VisualizarJson(): string
    {
        ...
        if ($teste === 'mockup') {
            ...
            $dados = ProdutoParcelaHomeMockup::pesquisarDados();
        ...
        if ($teste === 'transfer') {
            ...
            header('Content-Type: application/json; charset=utf-8');
            $mockupDados = ProdutoParcelaHomeMockup::pesquisarDados();
