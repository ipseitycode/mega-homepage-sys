...
require 'transfer/ProdutoCashbackHomeTransfer.php';

require 'repository/ProdutoCashbackHomeRepository.php';
require 'configuration/ProdutoCashbackHomeConfiguration.php';
...
require 'controller/ProdutoCashbackHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoCashbackHomeController();
    ...
    public function service()
    {
        ...
        $service = new ProdutoCashbackHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoCashbackHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoCashbackHomeResponseTransfer;
        $mockupLista = ProdutoCashbackHomeMockup::retornarLista();
        $mockupItem = ProdutoCashbackHomeMockup::retornarItem();

        $response = new ProdutoCashbackHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoCashbackHomeRequest();
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoCashbackHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoCashbackHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoCashbackHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoCashbackHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoCashbackHomeView();
