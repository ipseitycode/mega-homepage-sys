...
require 'transfer/ProdutoFreteHomeTransfer.php';

require 'repository/ProdutoFreteHomeRepository.php';
require 'configuration/ProdutoFreteHomeConfiguration.php';
...
require 'widget/ProdutoFreteHomeWidget.php';
require 'controller/ProdutoFreteHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoFreteHomeController();
    ...
    public function service()
    {
        ...
        $requestTransfer = new ProdutoFreteHomeRequestTransfer;
        $service = new ProdutoFreteHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoFreteHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoFreteHomeResponseTransfer;
        $mockupLista = ProdutoFreteHomeMockup::retornarLista();
        $mockupItem = ProdutoFreteHomeMockup::retornarItem();

        $response = new ProdutoFreteHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoFreteHomeRequest();
    ...
    public function transfer()
    {
        header('Content-Type: application/json; charset=utf-8');
        $mockupDados = ProdutoFreteHomeMockup::retornarItem();
        $objetoLista = new ProdutoFreteHomeTransfer($mockupDados);
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoFreteHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoFreteHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoFreteHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoFreteHomeException::$metodo($servico, $descricao);
            }
        }
