...
require_once 'mockup/ProdutoLojaHomeMockup.php';

require_once '../includes/interfaces/ProdutoHomeTransferInterface.php';
require_once 'transfer/ProdutoLojaHomeTransfer.php';
require_once 'mockup/ProdutoLojaHomeMockup.php';
...
class Startup
{
    public static function VisualizarJson(): string
    {
        ...
        if ($teste === 'mockup') {
            ...
            $dados = ProdutoLojaHomeMockup::pesquisarDados();
        ...
        if ($teste === 'transfer') {
            ...
            header('Content-Type: application/json; charset=utf-8');
            $mockupDados = ProdutoLojaHomeMockup::pesquisarDados();
