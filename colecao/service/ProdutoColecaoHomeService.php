...
class ProdutoColecaoHomeService
{
    private $validator;
    private $mockup;
    private $response;
    ...
    public function __construct($requestTransfer) 
    {
        ...
        $this->mockup = new ProdutoColecaoHomeMockup();
        $this->response = new ProdutoColecaoHomeResponse();
        $this->requestTransfer = $requestTransfer;
        $this->responseTransfer = new ProdutoColecaoHomeResponseTransfer();
    }
            ...
            { 
                ...
                if ($this->validator->validarArray($dadosLista)) {
                    ...
                    { 
                        ...
                        $this->mensagem[] = ProdutoColecaoHomeException::inexistente(__METHOD__, 'receberSelecionar.inexistente');
                    }
                }

            } else {
                $this->mensagem[] = ProdutoColecaoHomeException::inexistente(__METHOD__, 'retornarLista.inexistente');
            }

        } catch (Exception $e) {
            $this->mensagem[] = ProdutoColecaoHomeException::incorreto(__METHOD__, 'service.incorreto=' . $e->getMessage());
        } 
