...
require_once 'mockup/ProdutoColecaoHomeMockup.php';

require_once '../includes/interfaces/ProdutoHomeTransferInterface.php';
require_once 'transfer/ProdutoColecaoHomeTransfer.php';
require_once 'mockup/ProdutoColecaoHomeMockup.php';
...
class Startup
{
    public static function VisualizarJson(): string
    {
        ...
        if ($teste === 'mockup') {
            ...
            $dados = ProdutoColecaoHomeMockup::pesquisarDados();
        ...
        if ($teste === 'transfer') {
            ...
            header('Content-Type: application/json; charset=utf-8');
            $mockupDados = ProdutoColecaoHomeMockup::pesquisarDados();
