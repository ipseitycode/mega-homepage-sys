...
require 'transfer/ProdutoColecaoHomeTransfer.php';

require 'repository/ProdutoColecaoHomeRepository.php';
require 'configuration/ProdutoColecaoHomeConfiguration.php';
...
require 'widget/ProdutoColecaoHomeWidget.php';
require 'controller/ProdutoColecaoHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoColecaoHomeController();
    ...
    public function service()
    {
        ...
        $requestTransfer = new ProdutoColecaoHomeRequestTransfer;
        $service = new ProdutoColecaoHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoColecaoHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoColecaoHomeResponseTransfer;
        $mockupLista = ProdutoColecaoHomeMockup::retornarLista();
        $mockupItem = ProdutoColecaoHomeMockup::retornarItem();

        $response = new ProdutoColecaoHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoColecaoHomeRequest();
    ...
    public function transfer()
    {
        header('Content-Type: application/json; charset=utf-8');
        $mockupDados = ProdutoColecaoHomeMockup::retornarItem();
        $objetoLista = new ProdutoColecaoHomeTransfer($mockupDados);
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoColecaoHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoColecaoHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoColecaoHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoColecaoHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoColecaoHomeView();
