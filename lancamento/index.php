...
require 'transfer/ProdutoLancamentoHomeTransfer.php';

require 'repository/ProdutoLancamentoHomeRepository.php';
require 'configuration/ProdutoLancamentoHomeConfiguration.php';
...
require 'controller/ProdutoLancamentoHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoLancamentoHomeController();
    ...
    public function service()
    {
        ...
        $service = new ProdutoLancamentoHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoLancamentoHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoLancamentoHomeResponseTransfer;
        $mockupLista = ProdutoLancamentoHomeMockup::retornarLista();
        $mockupItem = ProdutoLancamentoHomeMockup::retornarItem();

        $response = new ProdutoLancamentoHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoLancamentoHomeRequest();
    ...
    public function transfer()
    {
        header('Content-Type: application/json; charset=utf-8');
        $mockupDados = ProdutoLancamentoHomeMockup::retornarItem();
        $objetoLista = new ProdutoLancamentoHomeTransfer($mockupDados);
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoLancamentoHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoLancamentoHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoLancamentoHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoLancamentoHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoLancamentoHomeView();
    ...
    public function widget()
    {
        ...
        $widget = new ProdutoLancamentoHomeWidget($responseTransfer);
