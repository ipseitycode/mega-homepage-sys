...
require_once 'mockup/ProdutoLancamentoHomeMockup.php';

require_once '../includes/interfaces/ProdutoHomeTransferInterface.php';
require_once 'transfer/ProdutoLancamentoHomeTransfer.php';
require_once 'mockup/ProdutoLancamentoHomeMockup.php';
...
class Startup
{
    public static function VisualizarJson(): string
    {
        ...
        if ($teste === 'mockup') {
            ...
            $dados = ProdutoLancamentoHomeMockup::pesquisarDados();
        ...
        if ($teste === 'transfer') {
            ...
            header('Content-Type: application/json; charset=utf-8');
            $mockupDados = ProdutoLancamentoHomeMockup::pesquisarDados();
