...
require_once 'mockup/ProdutoSubcategoriaHomeMockup.php';

require_once '../includes/interfaces/ProdutoHomeTransferInterface.php';
require_once 'transfer/ProdutoSubcategoriaHomeTransfer.php';
require_once 'mockup/ProdutoSubcategoriaHomeMockup.php';
...
class Startup
{
    public static function VisualizarJson(): string
    {
        ...
        if ($teste === 'mockup') {
            ...
            $dados = ProdutoSubcategoriaHomeMockup::pesquisarDados();
        ...
        if ($teste === 'transfer') {
            ...
            header('Content-Type: application/json; charset=utf-8');
            $mockupDados = ProdutoSubcategoriaHomeMockup::pesquisarDados();
