...
require 'transfer/ProdutoPesquisaHomeTransfer.php';

require 'repository/ProdutoPesquisaHomeRepository.php';
require 'configuration/ProdutoPesquisaHomeConfiguration.php';
require 'mockup/ProdutoPesquisaHomeMockup.php';
require 'response/ProdutoPesquisaHomeResponse.php';
require 'service/ProdutoPesquisaHomeService.php';
require 'transfer/ProdutoPesquisaHomeResponseTransfer.php';
require 'transfer/ProdutoPesquisaHomeRequestTransfer.php';
require 'request/ProdutoPesquisaHomeRequest.php';
require 'view/ProdutoPesquisaHomeView.php';
require 'widget/ProdutoPesquisaHomeWidget.php';
require 'controller/ProdutoPesquisaHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoPesquisaHomeController();
    ...
    public function service()
    {
        ...
        $service = new ProdutoPesquisaHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoPesquisaHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoPesquisaHomeResponseTransfer;
        $mockupLista = ProdutoPesquisaHomeMockup::retornarLista();
        $mockupItem = ProdutoPesquisaHomeMockup::retornarItem();

        $response = new ProdutoPesquisaHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoPesquisaHomeRequest();
    ...
    public function transfer()
    {
        header('Content-Type: application/json; charset=utf-8');
        $mockupDados = ProdutoPesquisaHomeMockup::retornarItem();
        $objetoLista = new ProdutoPesquisaHomeTransfer($mockupDados);
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoPesquisaHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoPesquisaHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoPesquisaHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoPesquisaHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoPesquisaHomeView();
