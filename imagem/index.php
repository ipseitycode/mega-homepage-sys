...
require 'transfer/ProdutoImagemHomeTransfer.php';

require 'repository/ProdutoImagemHomeRepository.php';
require 'configuration/ProdutoImagemHomeConfiguration.php';
...
require 'controller/ProdutoImagemHomeController.php';
...
class Startup
{
    ...
    public function controller()
    {
        ...
        $controller = new ProdutoImagemHomeController();
    ...
    public function service()
    {
        ...
        $requestTransfer = new ProdutoImagemHomeRequestTransfer;
        $service = new ProdutoImagemHomeService($requestTransfer);

        $dados = $service->executarSelecionar();

        $mockupDados = ProdutoImagemHomeMockup::retornarItem();
    ...
    public function response()
    {
        ...
        $responseTransfer = new ProdutoImagemHomeResponseTransfer;
        $mockupLista = ProdutoImagemHomeMockup::retornarLista();
        $mockupItem = ProdutoImagemHomeMockup::retornarItem();

        $response = new ProdutoImagemHomeResponse();
    ...
    {   
        ...
        $request = new ProdutoImagemHomeRequest();
    ...
    {
        header('Content-Type: application/json; charset=utf-8');
        $dados = ProdutoImagemHomeMockup::retornarItem();
        return json_encode($dados, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function exception()
    {
        ...
        $servico = "ProdutoImagemHome::Exception";
        ...
        foreach ($metodos as $metodo) {
            if (method_exists('ProdutoImagemHomeException', $metodo)) {
                $descricao = "Testando o método {$metodo} da classe Exception";
                $resultados[$metodo] = ProdutoImagemHomeException::$metodo($servico, $descricao);
            }
        }
    ...
    public function view()
    {
        ...
        $view = new ProdutoImagemHomeView();
    ...
    public function widget()
    {
        ...
        $widget = new ProdutoImagemHomeWidget($responseTransfer);
